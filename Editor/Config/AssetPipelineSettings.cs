...
namespace AssetPipeline
{
    ...
    {
        const string kDefaultProfileStoragePath = "Assets/Editor/AssetPipeline/Settings/";
        static AssetPipelineSettings s_AssetPipelineSettings;
        public const string kSettingsPath = "Assets/Editor/AssetPipeline/Settings/AssetPipelineSettings.asset";
        public const string kDeveloperModeKey = "AssetPipelineDeveloperMode";
