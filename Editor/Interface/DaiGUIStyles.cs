...
namespace AssetPipeline
{
    ...
    {
        const string IconsFolderPath = "Assets/Editor/Assetpipeline/Editor/Resources/Icons/";
        ...
        public static GUIStyle boldLabel => s_BoldLabel ?? (s_BoldLabel = new GUIStyle(EditorStyles.boldLabel)
            { contentOffset = new Vector2(0, 0), margin = new RectOffset(0, 0, 0, 0) });
        ...
        public static GUIStyle treeViewLabel => s_TreeViewLabel ?? (s_TreeViewLabel = new GUIStyle(EditorStyles.label)
            { padding = new RectOffset(0, 0, 0, 0), richText = true, fontSize = 14 });
        ...
        public static GUIStyle importProfilePane => s_ImportProfilePane ?? (s_ImportProfilePane = new GUIStyle
            { padding = new RectOffset(10, 10, 10, 10), normal = new GUIStyleState { background = ColorPalette.Background.GetPixel() } });
        ...
        public static GUIStyle renameImportProfileTextField => s_RenameImportProfileTextField ?? (s_RenameImportProfileTextField = new GUIStyle(EditorStyles.textField)
            { fontSize = 22, font = EditorStyles.centeredGreyMiniLabel.font, margin = new RectOffset(6, 10, 4, 0), stretchWidth = true });

        public static GUIStyle renameImportProfileButton =>
            s_RenameImportProfileButton ?? (s_RenameImportProfileButton = new GUIStyle(button) { margin = new RectOffset(0, 0, 7, 0), fixedWidth = 80 });
        ...
        public static GUIStyle ignoreCaseOn = s_IgnoreCaseOn ?? (s_IgnoreCaseOn = new GUIStyle
            { normal = new GUIStyleState { background = AssetDatabase.LoadAssetAtPath<Texture2D>($"{IconsFolderPath}IgnoreCaseOn@2x.png") } });

        public static GUIStyle ignoreCaseOff = s_IgnoreCaseOff ?? (s_IgnoreCaseOff = new GUIStyle
            { normal = new GUIStyleState { background = AssetDatabase.LoadAssetAtPath<Texture2D>($"{IconsFolderPath}IgnoreCaseOff@2x.png") } });

        public static GUIStyle roundedRect = s_RoundedRect ?? (s_RoundedRect = new GUIStyle("sv_iconselector_labelselection")
            { padding = new RectOffset(15, 15, 15, 15), margin = new RectOffset(0, 0, 0, 0), stretchHeight = false });
