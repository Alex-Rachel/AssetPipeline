...
namespace AssetPipeline
{
    internal class ImportProfileAssetTableView : AAssetTableView
    {
        ...
        {
            var result = new ImportProfileAssetTableItem(id, depth, displayName, assetPath, isAsset, isAsset ? m_Profile : null);
            if (!ImportProfileAssetsViewerWindow.NeedShowFilterAssets && result.profileState == AssetProfileState.UnknownFileExtension)
            {
                return null;
            }
            return result;
