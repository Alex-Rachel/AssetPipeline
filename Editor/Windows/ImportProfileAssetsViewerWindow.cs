...
namespace AssetPipeline
{
    internal class ImportProfileAssetsViewerWindow : EditorWindow
    {
        ...
        private static bool m_NeedShowFilterAssets = false;

        internal static bool NeedShowFilterAssets
        {
            get
            {
                return m_NeedShowFilterAssets;
            }
            set
            {
                if (m_NeedShowFilterAssets != value)
                {
                    m_NeedShowFilterAssets = value;
                    OnFilterAssetsChanged?.Invoke();
                }
            }
        }
        
        private static Action OnFilterAssetsChanged;
        ...
        void DrawToolbar()
        {
            ...
            GUILayout.Space(10);
            NeedShowFilterAssets = GUILayout.Toggle( NeedShowFilterAssets,"是否显示不处理的资源");
